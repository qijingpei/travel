...
<body >
    ...
    <ul style="list-sytle:none"> 
        ...
        <c:forEach items="${travelItemList }" var="t">
        	<li style="float:left;">
    		<!-- 一个旅游团报项目 -->
			<div class="travelItem" style=" background-color:#FFF; margin-left:20px;margin-top:20px; width:270px; height:290px;">
    		<a href="<c:url value='/AdminTravelItemServlet?method=load&titid=${t.titid }'/>">
