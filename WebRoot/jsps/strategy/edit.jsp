...
<input type="hidden" name="cstid" value="${strategy.cstid }"/>
<!-- 城市列表 -->
<br/>
标题：<input type="text" style="margin-top:5px;width:450px; height:25px;" name="title" value="${strategy.title }"/>
<br/><br/>
...
<br/>
<input style="align:middle;" type="submit" name="submit" onclick="getContent()" value="完成修改"  />
</form>
</div>
