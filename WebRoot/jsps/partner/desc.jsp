...
<form action="<c:url value='/PartnerServlet'/>" method="post">
<input type="hidden" name="method" value="edit"/>
<input type="hidden" name="fpaid" value="${partner.fpaid }"/>
<!-- 城市列表 -->
<!--
城市：<select style="width:150px; height:20px;" name="cityid">
 ...
 -->
<b>标题：</b>&nbsp;&nbsp;<input type="text" style="margin-top:5px;width:450px; height:25px;font-size:18;" name="title" value="${partner.title }"/>
<br/>
出发地点：<input type="text" style="margin-top:10px;height:22px;" name="startPlace" value="${partner.startPlace }"/>	&nbsp;&nbsp;&nbsp;
目标地：<input type="text" style="margin-top:5px;height:22px;" name="endPlace" value="${partner.endPlace }"/>
<br/>
出发时间：<input type="text" style="margin-top:5px;height:22px;" name="startTime" value="${partner.startTime }"/>	&nbsp;&nbsp;&nbsp;
天数：&nbsp;<input type="text" style="margin-top:5px; width:100px; height:22px;" name="days" value="${partner.days }"/>天
<br/>
联系方式：&nbsp;&nbsp;<input type="text" style="margin-top:5px;width:100px;height:22px;margin-bottom:20px;" name="phoneNumber" value="${partner.phoneNumber}"/>	&nbsp;&nbsp;&nbsp;
<br/>
...
<br/>
<input style="margin-left:100px;width:100px;height:30px;" type="submit" name="submit" onclick="getContent()" value="保存"  />
