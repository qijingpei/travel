...
<br/>
联系方式：&nbsp;&nbsp;<input type="text" style="margin-top:5px;width:100px;height:22px;margin-bottom:20px;" name="phoneNumber" value="${partner.phoneNumber}"/>元	&nbsp;&nbsp;&nbsp;
<br/>
